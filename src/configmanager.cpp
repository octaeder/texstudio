...
#else
	QSet<int> reservedShortcuts = QSet<int>() << QKeySequence(QKeyCombination(Qt::SHIFT,Qt::Key_F3))[0];  // [0] needed for conversion to int // workaround to prevent overwriting search backward
#endif
